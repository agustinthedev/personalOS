      ...
      <section className="soft-grid px-4 py-5 md:px-8">
        <div className="mx-auto max-w-7xl">
          <header className="mb-5 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="panel-muted rounded-[28px] p-4 text-sm text-zinc-300">
              <p className="font-mono text-zinc-400">report.blog.status</p>
            ...
            <div className="grid gap-4">
              {articles.map((article) => (
                <Link
                  ...
                  className="panel group overflow-hidden rounded-[28px] transition hover:-translate-y-0.5 hover:border-white/45"
                >
                  <div className="grid gap-5 p-5 md:grid-cols-[minmax(0,1fr)_260px]">
                    ...
                    <div className="flex flex-col justify-between gap-5 border-t border-white/10 pt-5 md:border-l md:border-t-0 md:pl-5 md:pt-0">
                      ...
                      <div className="sparkline h-20 rounded-[28px] bg-gradient-to-t from-white/35 to-zinc-500/5" />
                    </div>
                  </div>
